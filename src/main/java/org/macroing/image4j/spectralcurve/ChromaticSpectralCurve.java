...
public final class ChromaticSpectralCurve extends SpectralCurve {
	...
	private static final XYZColor S0_XYZ;
	private static final XYZColor S1_XYZ;
	private static final XYZColor S2_XYZ;
	...
	/**
	 * Returns an {@link XYZColor} given {@code x} and {@code y}.
	 * 
	 * @param x the X of the chromaticity pair
	 * @param y the Y of the chromaticity pair
	 * @return an {@code XYZColor} given {@code x} and {@code y}
	 */
	public static XYZColor getXYZ(final float x, final float y) {
		...
		final float x0 = S0_XYZ.x + m1 * S1_XYZ.x + m2 * S2_XYZ.x;
		final float y0 = S0_XYZ.y + m1 * S1_XYZ.y + m2 * S2_XYZ.y;
		final float z0 = S0_XYZ.z + m1 * S1_XYZ.z + m2 * S2_XYZ.z;
		
		return new XYZColor(x0, y0, z0);
	}
}